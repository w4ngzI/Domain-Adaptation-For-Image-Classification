GPU_ID=0
filename='logs/exp1226_mmd+ad.log'
...
CUDA_VISIBLE_DEVICES=$GPU_ID python3 main.py --train_batch_size 32 --dataset office-home --name ar --source_list data/office-home/Art.txt --target_list data/office-home/Real_World.txt --test_list data/office-home/Real_World.txt --num_classes 65 --model_type ViT-B_16 --pretrained_dir checkpoint/ViT-B_16.npz --num_steps 5000 --img_size 256 --beta 0.1 --gamma 0.01 --use_im --theta 0.1 --file_name $filename
...
CUDA_VISIBLE_DEVICES=$GPU_ID python3 main.py --train_batch_size 32 --dataset office-home --name cr --source_list data/office-home/Clipart.txt --target_list data/office-home/Real_World.txt --test_list data/office-home/Real_World.txt --num_classes 65 --model_type ViT-B_16 --pretrained_dir checkpoint/ViT-B_16.npz --num_steps 5000 --img_size 256 --beta 0.1 --gamma 0.01 --use_im --theta 0.1 --file_name $filename
...
CUDA_VISIBLE_DEVICES=$GPU_ID python3 main.py --train_batch_size 32 --dataset office-home --name pr --source_list data/office-home/Product.txt --target_list data/office-home/Real_World.txt --test_list data/office-home/Real_World.txt --num_classes 65 --model_type ViT-B_16 --pretrained_dir checkpoint/ViT-B_16.npz --num_steps 5000 --img_size 256 --beta 0.1 --gamma 0.01 --use_im --theta 0.1 --file_name $filename
